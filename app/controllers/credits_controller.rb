class CreditsController < ApplicationController
  ...
  def create
    ...
    if @credit.save
      redirect_to credits_path(:university => @credit.university)
    else
      redirect_to new_credit_path(:university => @credit.university)
    end
  end
  ...
  private
    ...
    def credit_params
      params.require(:credit).permit(:university,:name, :mesto, :link, :date1, :date2, :credit)
    end
end
