...
class SyllabusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create syllabus" do
    assert_difference('Syllabus.count') do
      post syllabuses_url, params: { syllabus: { coordinator: @syllabus.coordinator, school: @syllabus.school, university: @syllabus.university } }
    end
  ...
  test "should update syllabus" do
    patch syllabus_url(@syllabus), params: { syllabus: { coordinator: @syllabus.coordinator, school: @syllabus.school, university: @syllabus.university } }
