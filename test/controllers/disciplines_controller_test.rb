...
class DisciplinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discipline" do
    assert_difference('Discipline.count') do
      post disciplines_url, params: { discipline: { estimation: @discipline.estimation, name: @discipline.name, speciality: @discipline.speciality, university: @discipline.university, user: @discipline.user } }
    end
  ...
  test "should update discipline" do
    patch discipline_url(@discipline), params: { discipline: { estimation: @discipline.estimation, name: @discipline.name, speciality: @discipline.speciality, university: @discipline.university, user: @discipline.user } }
