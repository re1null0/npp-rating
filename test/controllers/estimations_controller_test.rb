...
class EstimationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estimation" do
    assert_difference('Estimation.count') do
      post estimations_url, params: { estimation: { discipline: @estimation.discipline, speciality: @estimation.speciality, university: @estimation.university, user: @estimation.user } }
    end
  ...
  test "should update estimation" do
    patch estimation_url(@estimation), params: { estimation: { discipline: @estimation.discipline, speciality: @estimation.speciality, university: @estimation.university, user: @estimation.user } }
