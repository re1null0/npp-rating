...
class EstimationsTest < ApplicationSystemTestCase
  ...
  test "creating a Estimation" do
    ...
    fill_in "Discipline", with: @estimation.discipline
    fill_in "Speciality", with: @estimation.speciality
    fill_in "University", with: @estimation.university
    fill_in "User", with: @estimation.user
