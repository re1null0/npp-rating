...
class DisciplinesTest < ApplicationSystemTestCase
  ...
  test "creating a Discipline" do
    ...
    fill_in "Estimation", with: @discipline.estimation
    fill_in "Name", with: @discipline.name
    fill_in "Speciality", with: @discipline.speciality
    fill_in "University", with: @discipline.university
    fill_in "User", with: @discipline.user
